...
define('TIME_MS_SECOND', 1000);
define('TIME_MS_HALF_MINUTE', 30000);
define('TIME_MS_MINUTE', 60000);
define('TIME_MS_FIVE_MINUTE', 300000);
define('TIME_MS_HALF_HOUR', 1800000);
define('TIME_MS_HOUR', 3600000);
define('TIME_MS_DAY', 86400000);
define('TIME_MS_WEEK', 604800000);
define('TIME_MS_MONTH', 2592000000);
define('TIME_MS_YEAR', 31536000000);
...
class Cache {
    ...
    public function set($data = false, $ttl = 300) {
        ...
        try {
            ...
            echo '<h1>Error</h1><br>';
            echo '<p>' . $this->getError() . '</p><br><br>';
            echo '<p>Deze error word waarschijnlijk veroorzaakt doordat de cache map ("' . Config::$cache_dir . '") niet schrijfbaar is!</p>';
            return false;
        }
        return $status;
    }
